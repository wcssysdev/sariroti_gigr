                        ...
                        <table class="table table-bordered table-checkable" id="kt_datatable1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($row["TR_GR_HEADER_STATUS"] == "ERROR" || $row["TR_GR_HEADER_STATUS"] == "PENDING")
                        ...
                        <table class="table table-bordered table-checkable" id="kt_datatable2">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($row["TR_GI_SAPHEADER_STATUS"] == "ERROR" || $row["TR_GI_SAPHEADER_STATUS"] == "PENDING")
                        ...
                        <table class="table table-bordered table-checkable" id="kt_datatable3">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($row["TR_TP_HEADER_STATUS"] == "ERROR" || $row["TR_TP_HEADER_STATUS"] == "PENDING")
                        ...
                        <table class="table table-bordered table-checkable" id="kt_datatable4">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($row["TR_CANCELLATION_MVT_STATUS"] == "ERROR" || $row["TR_CANCELLATION_MVT_STATUS"] == "PENDING")
                        ...
                        <table class="table table-bordered table-checkable" id="kt_datatable5">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($row["TR_PID_HEADER_STATUS"] == "ERROR" || $row["TR_PID_HEADER_STATUS"] == "PENDING")
