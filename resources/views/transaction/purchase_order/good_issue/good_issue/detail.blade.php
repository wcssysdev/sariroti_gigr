...
<script src="{{ asset('custom/js/transaction/delete/submit_ajax.js') }}"></script>
@endpush
        ...
        <div class="row justify-content-center py-8 px-8 py-md-0 px-md-0">
            <div class="col-md-11">
                <div class="form-group row pt-6">
                    ...
                    @if (count($gi_data) == 0)
                    <div class="col-lg-2">
                        <a href="{{ route('purchase_order_good_issue_add_', ['gi_po_number' => $header_data["TR_PO_HEADER_NUMBER"]]) }}" class="btn btn-primary font-weight-bolder"><span class="fas fa-plus-circle"></span>&nbsp;Create Good Issue</a>
                    </div>
                    @endif
                    @endif
                </div>
                    ...
                    <table class="table table-bordered table-checkable" id="kt_datatable2">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td nowrap="nowrap">
                                    <a href="{{ route('purchase_order_good_issue_detail_detail', ['gi_header_id' => $row["TR_GI_SAPHEADER_ID"]]) }}" class="btn btn-sm btn-clean btn-icon"> <i class="la la-eye"></i>
                                    </a>
                                    <a href="{{ route('purchase_order_good_issue_detail_print', ['gi_header_id' => $row["TR_GI_SAPHEADER_ID"]]) }}" target="_blank" class="btn btn-sm btn-clean btn-icon"> <i class="la la-print"></i>
                                    </a>
                                    @if ($row["TR_GI_SAPHEADER_STATUS"] == "ERROR")
                                    <a data-action="{{ route('purchase_order_good_issue_detail_delete', ['gi_header_id' => $row["TR_GI_SAPHEADER_ID"]]) }}" data-form-success-redirect="{{ route('purchase_order_good_issue_view') }}" class="btn btn-sm btn-clean btn-icon" id="delete_transaction_button"> <i class="la la-trash"></i>
                                    </a>
                                    @endif
                                </td>
                            </tr>
        ...
        <div class="row justify-content-center py-8 px-8 py-md-10 px-md-0">
            <div class="col-md-1">
                <div class="d-flex justify-content-between">
                    <a href="{{ route("purchase_order_good_issue_view") }}" class="btn btn-secondary"><i class="fas fa-angle-double-left"></i> Back</a>
                </div>
            </div>
            <div class="col-md-10">
            </div>
