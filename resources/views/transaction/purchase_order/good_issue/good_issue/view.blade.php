...
@push('scripts')
<script src="{{ asset('custom/js/transaction/gi_sto/zgi_sto/view/datatable.js') }}"></script>
<script src="{{ asset('custom/js/transaction/gi_sto/zgi_sto/view/delete_ajax.js') }}"></script>
<script src="{{ asset('custom/js/transaction/gi_sto/zgi_sto/view/select2.js') }}"></script>
@endpush
        ...
        <div class="card-body">
            ...
            <div class="col-lg-3">
                ...
                <select class="form-control" id="vendor_select2" name="vendor_code">
                    ...
                    <option value="{{ $row["MA_VENDOR_CODE"] }}" @if ($row["MA_VENDOR_CODE"]==$vendor_selected) selected @endif>{{ $row["MA_VENDOR_CODE"] }} - {{ $row["MA_VENDOR_NAME"] }}</option>
                    @endforeach
                </select>
            </div>
            <div class="col-lg-2">
        ...
        <table class="table table-bordered table-checkable" id="kt_datatable1">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td nowrap="nowrap">
                        <a href="{{ route('purchase_order_good_issue_detail_', ['gi_po_number' => $row["TR_PO_HEADER_NUMBER"]]) }}" class="btn btn-sm btn-clean btn-icon"> <i class="la la-eye"></i>
                        </a>
                    </td>
                </tr>
                @endforeach
