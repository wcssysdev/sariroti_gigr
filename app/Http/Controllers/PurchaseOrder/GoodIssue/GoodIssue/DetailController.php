...
class DetailController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('transaction/purchase_order/good_issue/good_issue/detail', [
            "header_data" => $data,
    ...
    public function detail(Request $request)
    {
        ...
        return view('transaction/purchase_order/good_issue/good_issue/detail_detail', [
            "header_data" => $data,
            "detail_data" => $detail_data
        ]);
    }
    ...
    public function print_qr(Request $request)
    {
        ...
        return view('transaction/purchase_order/good_issue/good_issue/print_qr', [
            "data" => $data
        ]);
    }
    ...
    public function print(Request $request)
    {
        ...
        return view('transaction/purchase_order/good_issue/good_issue/print', [
            "header_data" => $data,
            "detail_data" => $detail_data
        ]);
    }
