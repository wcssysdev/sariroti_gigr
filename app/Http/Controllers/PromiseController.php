...
class PromiseController extends Controller
{
    ...
    {
        $base_url = storage_path('app/public/OUTGOING/MIGO/');
        $base_url_success = storage_path('app/public/OUTGOING/MIGO_BACKUP/');
    ...
    {
        $base_url = storage_path('app/public/OUTGOING/PID_DOC/');
        $base_url_success = storage_path('app/public/OUTGOING/PID__DOC_BACKUP/');
