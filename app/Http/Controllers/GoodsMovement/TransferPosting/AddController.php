    ...
    public function save(Request $request)
    {
        ...
        if ($request->TR_TP_HEADER_MVT_CODE != "Y21") {
            foreach ($posting_materials as $row) {
                ...
                if ($row["TR_GR_DETAIL_LOCK_BOOKED_SLOC"] != "1100" || $row["TR_GR_DETAIL_LOCK_BOOKED_SLOC"] == "1900" || $row["TR_GR_DETAIL_LOCK_BOOKED_SLOC"] == "1419" || $row["TR_GR_DETAIL_LOCK_BOOKED_SLOC"] == "1300" || $row["TR_GR_DETAIL_LOCK_BOOKED_SLOC"] == "1400" || $row["TR_GR_DETAIL_LOCK_BOOKED_SLOC"] == "1319"){
                    $gr_detail = std_get([
                        "select" => ["*"],
                        "table_name" => "TR_GR_DETAIL",
                        "where" => [
