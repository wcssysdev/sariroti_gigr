...
class ViewController extends Controller
{
    ...
    {
        $data = get_master_data("MA_VENDOR");
        return view('master_data/vendor/view', [
            "data" => $data
        ]);
    }
    ...
    {
        $response = export_request_master_data_csv("vendor","VENDOR");
    ...
    {
        $response = sync_master_data("VENDOR");
        if ($response["code"] == 200) {
            return response()->json([
                "code" => 200,
