...
class ReceivePoSap extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'cron:receive_po_sap';
     ...
     * @var string
     */
    protected $description = 'Receive PO Data from SAP';
    ...
    {
        $base_url = storage_path('app/public/OUTGOING/PO_DATA/');
        $base_url_success = storage_path('app/public/OUTGOING/PO_DATA_BACKUP/');
